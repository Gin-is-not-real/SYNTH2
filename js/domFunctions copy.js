...
function defaultControlOnInput(control) {
    ...
    control.target[control.targetedParam] = parseInt(control.value);
    if(control.target[control.targetedParam].length > 1) {
        updateControls(control.value, control.target, control.targetedParam)
    }  
}
